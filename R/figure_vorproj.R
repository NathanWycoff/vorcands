...
points(Xcand[,1], Xcand[,2], col = 'gray')
points(X[,1], X[,2], col = 'red', pch = 4, lwd = 6)
points(lhs_point[1], lhs_point[2], col = 'orange', pch = 5, lwd = 7.5)
points(lhs_proj[1], lhs_proj[2], col = 'cyan', pch = 2, lwd = 6)
dev.off()
...
points(Xlhs[,1], Xlhs[,2], col = 'orange', pch = 5, lwd = 2)
points(lhs_proj[,1], lhs_proj[,2], col = 'cyan', pch = 2, lwd = 2)
dev.off()
